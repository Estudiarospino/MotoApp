...
export type CarteraFiltrosValor = { q: string; estado: string };

const ESTADO_OPCIONES = [
  { value: "todos", label: "Todos" },
  { value: "al_dia", label: "Al día" },
  { value: "en_mora", label: "En mora" },
  { value: "atraso_critico", label: "Atraso crítico" },
];

const VALORES_DEFECTO: CarteraFiltrosValor = { q: "", estado: "todos" };
...
export function CarteraFilters({
  ...
  function navegar(cambios: Partial<CarteraFiltrosValor>) {
  ...
  const hayFiltrosActivos = valores.q !== "" || valores.estado !== "todos";
